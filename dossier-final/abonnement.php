...
<script>
    ...
    <?php
     ...
     ?>
      ...
      <main class="abonnement clearfix">
        <ul>
        ...
        <form class="formulaire" action="abonnement.php" method="post">
        ...
        <div class="cost-container">
          ...
          <ul class="col2">
            <li><p>FRANCE, DOM-TOM, EUROPE</p></li><br>
            <li>
            <form>
                  <select value="Quantité" name="type" id="">
                    <option value="1">1</option>
                    <option value="2">2</option>
                  </select>
                </form></li><br>
            <li>Prix : 19 € (frais de port)</li><br>
          </ul>
        </div>
        <div class="footer">
